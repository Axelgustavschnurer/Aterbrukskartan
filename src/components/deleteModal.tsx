    ...
    <div className={`${styles.container} ${modalState ? styles.active : ''}`}>
      <div className={styles.modal}>
        ...
        <div className={styles.btnContainer}>
          <button type="button" style={{ backgroundColor: "var(--light)", color: "black" }} onClick={action}>Avbryt</button>
          <button type="button" className="danger" style={{ flexGrow: "unset", padding: "1em" }} onClick={handleDelete}>Radera</button>
        </div>
      </div>
    </div >
  )
      ...
      <div className={styles.modal}>
        ...
        <div className={styles.btnContainer}>
          <div className={styles.btn} onClick={() => handleDelete()}>
            <button type="button" style={{ backgroundColor: 'red' }}>Ta bort</button>
          </div>
