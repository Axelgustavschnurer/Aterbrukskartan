...
//     const values: any[] = [useState(currentDate), useState(currentDate + 10)];
...
//                             <input id="minSlider" type="range" min={currentDate} max={currentDate + 10} value={minValue} onChange={handleMinChange}/>
//                             <input id="maxSlider" type="range" min={currentDate} max={currentDate + 10} value={maxValue} onChange={handleMaxChange}/>
//                             <p style={{ margin: "10px" }}>År: {minValue} - {maxValue}</p>
//                         </div>
//                     </div>
